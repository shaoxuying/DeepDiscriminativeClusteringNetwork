...
def train_depict(dataset, X, y, input_var, decoder, encoder, loss_recons, num_clusters, y_pred, output_path,
    ...
    # print([params2,verify_m])
    # print(params2.type())
    # params2 = params2.append(verify_m)
    ...
    # loss_verify_init = verify_mult * T.mean(T.maximum((loss_verifi * verify_coef + verify_m),0))
    # loss_verify_init = verify_mult * T.mean(loss_verifi * verify_coef_init)
